...
<body class="permission_denied">
  ...
  <div id="div_str">
  	<center>
	  <h1><strong><c:out value='${error_code}'/></strong></h1>
	  <h3><c:out value='${msg_ko}'/></h3>
	  
	  
	  <div id="div_sub_comment"><c:out value='${msg_en}'/><br><br> 아래 연락처로 연락바랍니다.<br> PHONE.010-xxxx-xxxx</div>
	</center>
  </div>
